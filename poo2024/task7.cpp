...
int main() {
	//----------task7----------
	Stilou* s = new Stilou();
	Stilou* s1 = new Stilou("Alb", 12, "Schneider", 10);
	Highlighter h("Roz", 14, "Daco", 8);
	Highlighter h1("Verde", 13, "Daco", 11);
	...
	Librarie l1("Bucuresti", 100, 20, 24);
	Librarie l2("Timisoara", 300, 40, 34, "Carturesti", s, h, 3, caiete);

	cout << l2 << endl;
	cout << l2.getIncasariPeZi() << endl;
	cout << l1.getPretCarte() << endl;
	l1.setPretCarte(30);
	cout << l1.getPretCarte() << endl;
	cout << l2.getNumarCartiDupaVanzare() << endl;

	int nrCartiDisponibile = (int)l1;
	cout << "Numar carti disponibile: " << nrCartiDisponibile << endl;
	...
	PapetarieOnline po1;
	PapetarieOnline po2("papetarie.ro", 6, "Papetarie", s, h, 3, caiete);
	cout << po2 << endl;

	cin >> po1;
	cout << po1 << endl;
	cout << po1.getNrColaboratori() << endl;
	cout << po2.getSite();
	int nrColaboratori = (int)po2;
	cout << "\nNumar colaboratori: " << nrColaboratori << endl;
	cout << po2.getNume() << endl;
