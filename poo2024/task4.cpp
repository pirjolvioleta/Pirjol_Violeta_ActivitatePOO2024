...
int main() {
	...
	s5.afisareStilou();
	Highlighter h5 = h3;
	h5.afisareHighlighter();
	Caiet caiet5 = caiet3;
	caiet5.afisareCaiet();

	Stilou s6 = stilou2 + s5;
	cout << s6.getLungime() << endl;
	s6+=stilou2;
	cout << s6.getLungime() << endl;
	cout << endl;
	cout << s6 << endl;
	...
	cout << s6 << endl;
	if (h3 > h1) {
		cout << "h3 este mai greu" << endl;
	}

	if (h1 == h5) {
		cout << "h1 si h5 au aceeasi greutate." << endl;
	}
	else {
		cout << "Au greutati diferite." << endl;
	}
	...
	Caiet caiet6 = 10 + caiet1;
	cout << caiet6.getPret() << endl;

	float pret = (float)caiet2;
	cout << pret << endl;
